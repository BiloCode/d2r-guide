...
import { RunewordProvider } from "@/providers/runeword-provider";
...
import { RunewordDetailsServer } from "@/components/runeword-details-server";
  ...
  return (
    ...
    >
      <Wrapper className="w-full">
        ...
        <RunewordDetailsServer locale={locale} />
      </Wrapper>
    </RunewordProvider>
  );
}
